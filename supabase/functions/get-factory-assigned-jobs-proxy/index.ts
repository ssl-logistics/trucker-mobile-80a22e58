...
serve(async (req) => {
  ...
  try {
    ...
    console.log('Proxy: Fetching factory assigned jobs for driver:', freelanceDriverId);
    ...
    console.log('Proxy: Successfully fetched factory assigned jobs:', data?.data?.length || 0, 'items');
    ...
    console.error('Error in get-factory-assigned-jobs-proxy:', error);
