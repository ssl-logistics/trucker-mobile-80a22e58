...
ฟีเจอร์หลักของแอป:
1. Current Jobs - ดูงานที่กำลังทำอยู่
2. Bidding - ประมูลงานใหม่ (สำหรับ Freelance driver)
3. Income - ดูรายได้
4. Job History - ดูประวัติงาน
5. Chat - แชทกับผู้ว่าจ้าง
6. Settings - ตั้งค่าต่างๆ

ตอบสั้นกระชับ เป็นภาษาไทย ใช้คำสุภาพ`;
