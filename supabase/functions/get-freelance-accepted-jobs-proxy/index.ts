...
serve(async (req) => {
  ...
  try {
    ...
    console.log('Proxy: Fetching accepted jobs for driver:', freelanceDriverId);
    ...
    console.log('Proxy: Successfully fetched accepted jobs');
    ...
    console.error('Error in get-freelance-accepted-jobs-proxy:', error);
