...
const enTranslations: Record<string, string> = {
  ...
  'bidding.payToViewPrice': 'Pay deposit to view price',
  'bidding.payDepositToViewPrice': 'Pay deposit to view price',
  'bidding.depositAmount': 'Deposit',
  'bidding.depositPaid': 'Deposit paid successfully',
  'bidding.priceNowVisible': 'You can now view the price',
...
const koTranslations: Record<string, string> = {
  ...
  'bidding.payToViewPrice': '보증금을 내고 가격 보기',
  'bidding.payDepositToViewPrice': '가격을 보려면 보증금을 지불하세요',
  'bidding.depositAmount': '보증금',
  'bidding.depositPaid': '보증금 결제 완료',
  'bidding.priceNowVisible': '이제 가격을 볼 수 있습니다',
...
'reportProblem.uploadPhoto': '上传照片',
  ...
  'bidding.payToViewPrice': '付押金查看价格',
  'bidding.payDepositToViewPrice': '付押金查看价格',
  'bidding.depositAmount': '押金',
  'bidding.depositPaid': '押金支付成功',
  'bidding.priceNowVisible': '现在可以查看价格',
