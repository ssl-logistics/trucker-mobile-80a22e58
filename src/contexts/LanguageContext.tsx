...
const zhTranslations: Record<string, string> = {
  ...
  'terms.collection_intro': '我们收集以下类型的信息以提供和改进我们的服务：',
  'terms.personal_data': '个人数据：',
  'terms.personal_data_desc': '姓名、电子邮件地址、电话号码和配置文件信息',
  'terms.technical_data': '技术数据：',
  'terms.technical_data_desc': '车辆信息、文件和照片',
  'terms.price_data': '价格数据：',
  'terms.price_data_desc': '工作偏好和价格范围',
  'terms.financial_data': '财务数据：',
  'terms.financial_data_desc': '银行账户信息和支付历史',
  'terms.communication_data': '通信数据：',
  'terms.communication_data_desc': '消息、通知和支持请求',
  'terms.usage_title': '我们如何使用您的信息',
  'terms.usage_intro': '我们将您的信息用于以下目的：',
  'terms.usage_1': '提供和维护我们的服务',
  'terms.usage_2': '处理您的注册和账户管理',
  'terms.usage_3': '促进工作匹配和通信',
  'terms.usage_4': '处理支付和财务交易',
  'terms.usage_5': '改进我们的服务并开发新功能',
  'terms.usage_6': '向您发送更新和通知',
  'terms.sharing_title': '信息共享',
  'terms.sharing_intro': '我们可能在以下情况下共享您的信息：',
  'terms.sharing_provider': '与服务提供商：',
  'terms.sharing_provider_desc': '与帮助我们运营服务的第三方提供商共享',
  'terms.sharing_legal': '出于法律原因：',
  'terms.sharing_legal_desc': '当法律要求或保护我们的权利时',
  'terms.sharing_anonymous': '匿名数据：',
  'terms.sharing_anonymous_desc': '用于分析和改进的聚合和匿名数据',
