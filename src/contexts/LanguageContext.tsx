...
const thTranslations: Record<string, string> = {
  ...
  // Vehicle Photos Step
  'vehiclePhotosStep.front': 'รูปหน้ารถ',
  'vehiclePhotosStep.side': 'รูปข้างรถ',
  'vehiclePhotosStep.back': 'รูปหลังรถ',
  'vehiclePhotosStep.plate': 'รูปป้ายทะเบียน',
  'vehiclePhotosStep.hasTrailer': 'มีส่วนของหางลาก',
  'vehiclePhotosStep.trailerPlate': 'รูปภาพป้ายทะเบียนหางลาก',
  'vehiclePhotosStep.photoPrompt': 'กดเพื่อถ่ายรูปหรือเลือกรูป',
  ...
  'vehiclePhotosStep.backButton': 'ย้อนกลับ',
  ...
  'vehicleInfoStep.licenseDoc': 'ใบอนุญาติขับขี่',
  'vehicleInfoStep.idCardDoc': 'บัตรประชาชนผู้ขับ',
  'vehicleInfoStep.compulsoryInsuranceDoc': 'สำเนา พรบ.',
  'vehicleInfoStep.fileSelected': '✓ เลือกไฟล์แล้ว',
  'vehicleInfoStep.photoPrompt': 'กดเพื่อถ่ายรูปหรือเลือกรูป',
  'vehicleInfoStep.backButton': 'ย้อนกลับ',
...
const enTranslations: Record<string, string> = {
  ...
  // Vehicle Photos Step
  'vehiclePhotosStep.front': 'Front Photo',
  'vehiclePhotosStep.side': 'Side Photo',
  'vehiclePhotosStep.back': 'Back Photo',
  'vehiclePhotosStep.plate': 'License Plate Photo',
  'vehiclePhotosStep.hasTrailer': 'Has Trailer',
  'vehiclePhotosStep.trailerPlate': 'Trailer License Plate Photo',
  'vehiclePhotosStep.photoPrompt': 'Click to take or select photo',
  ...
  'vehiclePhotosStep.backButton': 'Back',
  ...
  'vehicleInfoStep.licenseDoc': 'Driver\'s License',
  'vehicleInfoStep.idCardDoc': 'Driver\'s ID Card',
  'vehicleInfoStep.compulsoryInsuranceDoc': 'Compulsory Insurance Copy',
  'vehicleInfoStep.fileSelected': '✓ File Selected',
  'vehicleInfoStep.photoPrompt': 'Click to take or select photo',
  'vehicleInfoStep.backButton': 'Back',
