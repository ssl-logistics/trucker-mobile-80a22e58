...
const thTranslations: Record<string, string> = {
  ...
  'market.price_not_set': 'ไม่ระบุราคา',
  'market.tab_urgent': 'งานด่วน',
  'market.tab_auction': 'ประมูล',
  'market.tab_interest': 'สนใจรับงาน',
  'market.bid_button': 'เสนอราคา',
  'market.interest_button': 'สนใจรับงาน',
  'market.bid_dialog_title': 'เสนอราคา',
  'market.bid_price_label': 'ราคาเสนอ (บาท)',
  'market.bid_price_placeholder': 'กรอกราคาที่ต้องการเสนอ',
  'market.bid_confirm': 'ยืนยันเสนอราคา',
  'market.bid_invalid': 'กรุณากรอกราคามากกว่า 0',
  'market.pending_title': 'บันทึกคำขอแล้ว',
  'market.pending_desc': 'ระบบรับงานตลาดกำลังเชื่อมต่อ ทีมงานจะติดต่อกลับเร็ว ๆ นี้',
  'market.interest_title': 'สนใจรับงานนี้?',
  'market.interest_message': 'กดยืนยันเพื่อแสดงความสนใจรับงานนี้',
  ...
  'jobDetail.customerInfo': 'ข้อมูลลูกค้า',
  'jobDetail.customerName': 'ชื่อลูกค้า',
  'jobDetail.taxId': 'เลขผู้เสียภาษี',
  'jobDetail.note': 'หมายเหตุ',
...
'reportProblem.uploadPhoto': 'อัพโหลดรูปสินค้า',
  ...
  'expense.price': 'ราคา',
  'expense.advancePayment': 'สำรองจ่าย',
  ...
  'delivery.deliveryTo': 'ส่งสินค้าที่',
...
const enTranslations: Record<string, string> = {
  ...
  'home.market': 'Market',
  'market.title': 'Transport Job Market',
  'market.search_placeholder': 'Search jobs (origin, destination, company, order no.)',
  'market.empty': 'No open jobs at the moment',
  'market.accept_unavailable_title': 'Accepting not available yet',
  'market.accept_unavailable_desc': 'Jobs from this marketplace cannot be accepted in the app yet',
  'market.price_not_set': 'Price not set',
  'market.tab_urgent': 'Urgent',
  'market.tab_auction': 'Auction',
  'market.tab_interest': 'Interested',
  'market.bid_button': 'Place bid',
  'market.interest_button': 'I\'m interested',
  'market.bid_dialog_title': 'Place a bid',
  'market.bid_price_label': 'Your price (THB)',
  'market.bid_price_placeholder': 'Enter your offer',
  'market.bid_confirm': 'Confirm bid',
  'market.bid_invalid': 'Please enter a price greater than 0',
  'market.pending_title': 'Request saved',
  'market.pending_desc': 'Marketplace integration is coming soon. Our team will contact you.',
  'market.interest_title': 'Interested in this job?',
  'market.interest_message': 'Confirm to show your interest in this job',
  ...
  'history.readOnlyTitle': 'Job closed',
  'history.readOnlyDesc': 'Jobs in history are view-only and cannot be updated.',
  'common.next': 'Next',
  'common.paid': 'Paid',
  ...
  'jobDetail.customerInfo': 'Customer Info',
  'jobDetail.customerName': 'Customer Name',
  'jobDetail.taxId': 'Tax ID',
  'jobDetail.note': 'Note',
...
'reportProblem.uploadPhoto': 'Upload Product Photo',
  ...
  'expense.price': 'Price',
  'expense.advancePayment': 'Advance payment',
...
const koTranslations: Record<string, string> = {
  ...
  'home.market': '마켓',
  'market.title': '운송 작업 마켓',
  'market.search_placeholder': '작업 검색 (출발지, 도착지, 회사, 주문번호)',
  'market.empty': '현재 모집 중인 작업이 없습니다',
  'market.accept_unavailable_title': '아직 수락할 수 없습니다',
  'market.accept_unavailable_desc': '이 마켓의 작업은 앱에서 아직 수락할 수 없습니다',
  'market.price_not_set': '가격 미정',
  'market.tab_urgent': '긴급 작업',
  'market.tab_auction': '경매',
  'market.tab_interest': '관심 작업',
  'market.bid_button': '입찰하기',
  'market.interest_button': '관심 있음',
  'market.bid_dialog_title': '입찰',
  'market.bid_price_label': '제안 가격 (바트)',
  'market.bid_price_placeholder': '제안 가격을 입력하세요',
  'market.bid_confirm': '입찰 확인',
  'market.bid_invalid': '0보다 큰 가격을 입력하세요',
  'market.pending_title': '요청이 저장되었습니다',
  'market.pending_desc': '마켓플레이스 연동 준비 중입니다. 담당자가 곧 연락드립니다.',
  'market.interest_title': '이 작업에 관심 있으신가요?',
  'market.interest_message': '확인을 눌러 관심을 표시하세요',
  ...
  'common.confirm': '확인',
  'common.previous': '이전',
  'history.readOnlyTitle': '종료된 작업',
  'history.readOnlyDesc': '기록의 작업은 조회만 가능하며 수정할 수 없습니다.',
  'common.next': '다음',
  'common.paid': '지불됨',
  'common.success': '성공',
  'common.error': '오류',
...
'reportProblem.uploadPhoto': '상품 사진 업로드',
  ...
  'jobDetail.customerInfo': '고객 정보',
  'jobDetail.customerName': '고객명',
  'jobDetail.taxId': '사업자번호',
  'jobDetail.note': '비고',
...
const zhTranslations: Record<string, string> = {
  ...
  'home.market': '市场',
  'market.title': '运输工作市场',
  'market.search_placeholder': '搜索工作（起点、终点、公司、订单号）',
  'market.empty': '目前没有开放的工作',
  'market.accept_unavailable_title': '暂不支持接单',
  'market.accept_unavailable_desc': '此市场的工作暂时无法在应用内接单',
  'market.price_not_set': '价格待定',
  'market.tab_urgent': '紧急任务',
  'market.tab_auction': '竞价',
  'market.tab_interest': '感兴趣',
  'market.bid_button': '出价',
  'market.interest_button': '我感兴趣',
  'market.bid_dialog_title': '出价',
  'market.bid_price_label': '您的报价（泰铢）',
  'market.bid_price_placeholder': '输入您的报价',
  'market.bid_confirm': '确认出价',
  'market.bid_invalid': '请输入大于 0 的价格',
  'market.pending_title': '请求已保存',
  'market.pending_desc': '市场接单功能即将上线，我们的团队会尽快联系您。',
  'market.interest_title': '对这份工作感兴趣？',
  'market.interest_message': '确认以表示您对该工作感兴趣',
  ...
  'jobDetail.customerInfo': '客户信息',
  'jobDetail.customerName': '客户名称',
  'jobDetail.taxId': '税号',
  'jobDetail.note': '备注',
...
'reportProblem.uploadPhoto': '上传照片',
  ...
  'common.next': '下一步',
  'common.previous': '上一步',
  'history.readOnlyTitle': '此工作已结束',
  'history.readOnlyDesc': '历史记录中的工作仅可查看，无法修改。',
  'common.submit': '提交',
  'common.search': '搜索',
  'common.filter': '筛选',
  'common.sort': '排序',
