...
export default function DomesticJobDetail({
  ...
  }, [jobApplication, job.destinations, pickupSopCompleted, pickupCheckedIn, deliveryCheckedIn, deliverySopCompleted, destinationCheckins, isContainerStepCompleted, emptyContainerCheckedIn, job.container_return_location, localDestOrder, isReorderMode]);
