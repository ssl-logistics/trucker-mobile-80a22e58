...
export default function InternationalJobDetail({ job, jobApplication, userId, onUpdate }: InternationalJobDetailProps) {
  const navigate = useNavigate();
  const card1Ref = useRef<HTMLDivElement>(null);
  const card2Ref = useRef<HTMLDivElement>(null);
  const card3Ref = useRef<HTMLDivElement>(null);
  const [cardHeights, setCardHeights] = useState({ card1: 0, card2: 0, card3: 0 });
  ...
  const mockContainerData = {
    ...
    containers: [
      { number: 'TGHU4455667', seal: 'SEAL556677' },
      { number: 'CAIU9988776', seal: 'SEAL112233' }
    ]
  };
        ...
        <div>
          ...
          <div className="relative flex gap-3">
            ...
            <div className="relative flex flex-col" style={{ width: '28px', paddingTop: '8px' }}>
              ...
              <div 
                ...
                style={{ 
                  ...
                  background: jobApplication?.delivery_sop_completed_at 
                    ...
                    ? `linear-gradient(to bottom, #ef4444 0%, #ef4444 ${cardHeights.card1 + cardHeights.card2 > 0 ? ((cardHeights.card1 + 12 + cardHeights.card2 / 2) / (cardHeights.card1 + 12 + cardHeights.card2 + 12 + cardHeights.card3)) * 100 : 66}%, #d1d5db ${cardHeights.card1 + cardHeights.card2 > 0 ? ((cardHeights.card1 + 12 + cardHeights.card2 / 2) / (cardHeights.card1 + 12 + cardHeights.card2 + 12 + cardHeights.card3)) * 100 : 66}%, #d1d5db 100%)`
                    : jobApplication?.container_sop_completed_at
                    ? `linear-gradient(to bottom, #ef4444 0%, #ef4444 ${cardHeights.card1 > 0 ? (cardHeights.card1 / 2 / (cardHeights.card1 + 12 + cardHeights.card2 + 12 + cardHeights.card3)) * 100 : 33}%, #d1d5db ${cardHeights.card1 > 0 ? (cardHeights.card1 / 2 / (cardHeights.card1 + 12 + cardHeights.card2 + 12 + cardHeights.card3)) * 100 : 33}%, #d1d5db 100%)`
                    : '#d1d5db'
                }} 
              />
              ...
              <div className="relative flex justify-center mb-3" style={{ height: `${cardHeights.card2 || 200}px` }}>
                <div className="absolute top-0">
                  {jobApplication?.sop_completed_at ? (
                    <div className="w-7 h-7 rounded-full bg-green-500 flex items-center justify-center shadow-md">
                      <CheckCircle className="w-4 h-4 text-white" />
              ...
              <div className="relative flex justify-center" style={{ height: `${cardHeights.card3 || 200}px` }}>
                <div className="absolute top-0">
