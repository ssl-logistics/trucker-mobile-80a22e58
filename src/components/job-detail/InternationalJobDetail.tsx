                ...
                <div className={`${!jobApplication?.job_started_at ? 'opacity-60' : ''}`}>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    if (jobApplication?.container_sop_completed_at) {
                      ...
                      <span className="text-[10px] leading-tight text-center">{jobApplication?.container_sop_completed_at ? t('jobDetail.viewInfo') : emptyContainerCheckedIn ? t('jobDetail.uploadEvidence') : t('jobDetail.updateStatus')}</span>
                    </Button>
                  </div>
                </div>
              </Card>
