...
export default function TermsPage() {
  ...
  return <div className="min-h-screen bg-background">
      ...
      <div className="bg-white p-6">
        <h2 className="font-bold text-primary mb-4 text-sm text-center">
          {t('terms.heading')}
        </h2>
        ...
        <div className="mb-6">
          ...
          <ul className="space-y-2 ml-4">
            ...
            <li className="text-foreground leading-relaxed text-sm">
              <span className="font-semibold">{t('terms.communication_data')}</span> {t('terms.communication_data_desc')}
            </li>
          </ul>
        </div>
