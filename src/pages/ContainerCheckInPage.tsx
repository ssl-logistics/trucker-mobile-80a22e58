        ...
        {job.container_return_location && (
          <Card className="overflow-hidden border-0 shadow-md rounded-2xl">
            <div className="bg-[#FFF3E0] px-4 py-3">
              <p className="text-sm font-medium text-[#E65100]">จุดคืนตู้</p>
              ...
              {job.container_return_latitude && job.container_return_longitude ? (
                <div className="h-40">
                  <GoogleMap 
                    ...
                    markerLabel={job.container_return_location}
                    showRoute={false}
                  />
                </div>
              ) : (
            ...
            <div className="p-4 space-y-2">
              {job.container_return_address && (
                <div>
                  ...
                  <p className="text-sm font-medium">{job.container_return_address}</p>
                </div>
              )}
              {job.container_return_phone && (
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm font-medium">{job.container_return_phone}</p>
                  </div>
                  <Button
                    variant="outline"
                    size="sm"
                    className="rounded-full border-[#E65100] text-[#E65100]"
            ...
            {/* Route to return location */}
            <div className="px-4 pb-4">
              <Button 
                variant="outline" 
                className="w-full h-10 text-sm border-[#E65100] text-[#E65100] rounded-full"
                onClick={() => {
                  if (job.container_return_latitude && job.container_return_longitude) {
                    ...
                    window.open(`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(job.container_return_location || '')}`, '_blank');
                  }
                }}
              >
