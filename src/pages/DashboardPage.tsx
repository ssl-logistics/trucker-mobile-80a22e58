...
export default function DashboardPage() {
  ...
  return <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white pb-20">
      ...
      <div className="px-4 py-6 space-y-4">
        {dashboardItems.map(item => <Card key={item.id} className="overflow-hidden shadow-md hover:shadow-lg transition-shadow cursor-pointer" onClick={() => navigate(item.path)}>
            <div style={{
