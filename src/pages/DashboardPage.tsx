...
export default function DashboardPage() {
  ...
  return <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white pb-20">
      ...
      <div className="px-4 py-6 space-y-4">
        {dashboardItems.map(item => <Card key={item.id} className="overflow-visible shadow-md hover:shadow-lg transition-shadow cursor-pointer" onClick={() => navigate(item.path)}>
            <div style={{
          backgroundImage: `url(${item.imageSrc})`,
          backgroundSize: "cover",
          backgroundPosition: "center",
          backgroundRepeat: "no-repeat"
        }} className="p-6 relative min-h-[120px] -mt-4 rounded-3xl  bg-black/0">
