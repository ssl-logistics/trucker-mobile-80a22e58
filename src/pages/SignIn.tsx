      ...
      <div className="flex-1 rounded-t-[3rem] -mt-8 px-6 pt-14 pb-2 bg-white overflow-y-auto">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 max-w-md mx-auto">
          ...
          <Button 
            ...
            disabled={isLoggingIn}
            className="w-full h-10 rounded-xl text-sm font-medium border-2 bg-[#00B900] hover:bg-[#00A000] text-white border-[#00B900] hover:border-[#00A000]"
          >
            ...
            {t('signIn.lineLogin') || 'เข้าสู่ระบบด้วย LINE'}
          </Button>
