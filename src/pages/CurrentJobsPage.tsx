      ...
      if (!bidWonJobsResult.error && bidWonJobsResult.data) {
        ...
        bidWonJobs = tickets
          ...
          .map((ticket: any) => ({
            ...
            sender_pickup_date: ticket.pickup_location?.date || ticket.pickup_date || (ticket.pickup_datetime ? ticket.pickup_datetime.split('T')[0] : null) || ticket.start_date || ticket.created_at?.split('T')[0],
            sender_pickup_time: ticket.pickup_location?.time || ticket.pickup_time || (ticket.pickup_datetime ? ticket.pickup_datetime.split('T')[1]?.substring(0, 5) : null) || ticket.start_time || '00:00',
            ...
            destination_delivery_date: ticket.dropoff_location?.date || ticket.delivery_date || (ticket.delivery_datetime ? ticket.delivery_datetime.split('T')[0] : null) || ticket.destination_date || ticket.pickup_date,
            destination_delivery_time: ticket.dropoff_location?.time || ticket.delivery_time || (ticket.delivery_datetime ? ticket.delivery_datetime.split('T')[1]?.substring(0, 5) : null) || ticket.destination_time || '00:00',
